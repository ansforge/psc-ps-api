...
public class PsOperationTest extends BaseOperationTest {
    ...
    public void getPsById() throws Exception {
        ...
        ResultActions firstPsRefRequest = mockMvc.perform(get("/api/v3/ps/800000000001")
        ...
        ResultActions secondPsRefRequest = mockMvc.perform(get("/api/v3/ps/800000000011")
                .header("Accept", "application/json"))
                .andExpect(status().is(200));
    ...
    public void getPsByEncodedId() throws Exception {
        ...
        String psAsJsonString = objectWriter.writeValueAsString(storedPs);
        ResultActions psRefRequest = mockMvc.perform(get("/api/v3/ps/80000000000%2F1")
                .header("Accept", "application/json"))
                .andExpect(status().is(200))
                .andDo(print());
    ...
    public void getPsWithoutJsonAcceptHeader() throws Exception {
        mockMvc.perform(get("/api/v3/ps/800000000001"))
                .andExpect(status().is(200));
    }
    ...
    public void getPsWithWrongHeaderFailed() throws Exception {
        mockMvc.perform(get("/api/v3/ps/800000000001").header("Accept","application/xml"))
    ...
    public void getPsDeactivated() throws Exception {
        mockMvc.perform(get("/api/v3/ps/800000000002")
                .header("Accept", "application/json"))
    ...
    public void getNotExistingPs() throws Exception {
        mockMvc.perform(get("/api/v3/ps/800000000003")
                .header("Accept", "application/json"))
                .andExpect(status().is(410));
    ...
    public void createNewPs() throws Exception {
        ...
        ResultActions createdPs = mockMvc.perform(post("/api/v3/ps").header("Accept", "application/json")
                .contentType("application/json").content("{\"idType\":\"8\",\"id\":\"00000000001\"," +
                        ...
                        "\"registrationAuthority\":\"ARS/ARS/ARS\",\"siteSIRET\":\"125 137 196 15574\",\"siteSIREN\":\"125 137 196\"," +
    ...
    public void createPsWrongContentTypeFailed() throws Exception {
        mockMvc.perform(post("/api/v3/ps").header("Accept", "application/json")
    ...
    public void deletePsById() throws Exception {
        ResultActions deletedPs = mockMvc.perform(delete("/api/v3/ps/800000000001"))
    ...
    public void deletePsFailed() throws Exception {
        mockMvc.perform(delete("/api/v3/ps/800000000003")
                .header("Accept", "application/json"))
                .andExpect(status().is(410));
    ...
    public void updatePs() throws Exception {
        ResultActions updatedPs = mockMvc.perform(put("/api/v3/ps").header("Accept", "application/json")
                .contentType("application/json").content("{\n" +
                        "\"idType\": \"8\",\n" +
                        "\"id\": \"00000000001\",\n" +
                        "\"nationalId\": \"800000000001\"\n" +
    ...
    public void updateAbsentPsFailed() throws Exception {
        mockMvc.perform(put("/api/v3/ps").header("Accept", "application/json")
                .contentType("application/json").content("{\n" +
                        "\"idType\": \"8\",\n" +
                        "\"id\": \"00000000001\",\n" +
                        "\"nationalId\": \"800000000001\"\n" +
    ...
    public void physicalDeleteById() throws Exception {
        mockMvc.perform(delete("/api/v3/ps/force/800000000001")
                .header("Accept", "application/json"))
                .andExpect(status().is(204));
        ...
        mockMvc.perform(delete("/api/v3/ps/force/800000000002")
                .header("Accept", "application/json"))
                .andExpect(status().is(204));
